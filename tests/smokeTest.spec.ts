...
test('Create and Delete Article', async ({ api }) => {
    ...
    expect(createArticleResponse.article.title).shouldEqual('Hello World1')
    ...
    expect(articlesResponse.articles[0].title).shouldEqual('Hello World1')
    ...
    expect(articlesResponseTwo.articles[0].title).not.shouldEqual('Hello World1')
})